...
app.put("/user/:ID",auth,upload.fields([
    ...
    var requestBody =  {
        ...
        mobileNumber: req.body.mobileNumber != 'null' && req.body.mobileNumber != 'undefined'? parseInt(req.body.mobileNumber,10) : null,
        ...
        whatsapp: req.body.whatsapp != 'null' && req.body.whatsapp != 'undefined' ? parseInt(req.body.whatsapp,10) : null,
        ...
        zipCode: req.body.zipCode != 'null' && req.body.zipCode != 'undefined' ? parseInt(req.body.zipCode,10) : null,
...
app.put('/user/card/update/:cardId',auth,upload.fields([
    ...
    try {
        var inputparam = {
            ...
            mobileNumber: req.body.mobileNumber != 'null' ? parseInt(req.body.mobileNumber,10) : null,
            ...
            whatsapp: req.body.whatsapp != 'null' ? parseInt(req.body.whatsapp,10) : null,
            ...
            zipCode: req.body.zipCode != 'null' ? parseInt(req.body.zipCode,10) : null,
